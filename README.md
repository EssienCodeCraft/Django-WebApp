...
<h4>Part 1:</h4>
<ol>
    <li>Create a web-app where a user can log in.</li>
...
<h4>Part 2:</h4>
<ol>
     <li> Users can search and view the profiles of other users.</li>
     <li>They can share their uploaded files with any users.</li>
     <li>Users can also see the shared files by other users in uploaded files.</li>
</ol>

<h4>Additional Features:</h4>
<ol>
    <li>In the user's profile user can set his/her profile picture.</li>
    <li>Users can download other user's uploaded files.</li>
    <li>The user can upload any files such as images, videos, text files, and also different types of programs like Python code, java code, etc.</li>
</ol>
...
<b>The Secret_Key required for the execution and debugging of the project is not removed from the project code. So you can use the project as your college mini-project or by using the project code you can build your project.</b>
